  ...
  render(){
      ...
      <section className="hero" style={divStyle}>
        <div className="hero-content p-x p-xl">
          ...
          <Link to="#" className="button-md button button-light m-t" target="_blank" download><img className="m-r i-md icon svg" src={require('../img/icons/play-icon-secondary.svg')} alt="play icon"/> Watch Trailer</Link>
        </div>
      </section>
