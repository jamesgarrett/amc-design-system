    ...
    // {this.props.network}
		return(
          ...
          <table className="row m-b m-lg">
                ...
                <tr className="row">
                  <td className="typeName col-3"><h1 className="secondary-1">Secondary 1</h1></td>
                ...
                <tr className="row">
                  <td className="typeName col-3"><h2 className="secondary-2">Secondary 2</h2></td>
                  <td className="col-1">10</td>
                  <td className="col-1">Uppercase</td>
                  <td className="col-1">400</td>
                  <td className="col-1">48</td>
                ...
                <tr className="row">
                  <td className="typeName col-3"><h3 className="secondary-3">Secondary 3</h3></td>
                  <td className="col-1">09</td>
                  <td className="col-1">Uppercase</td>
                  <td className="col-1">400</td>
                  <td className="col-1">40</td>
                ...
                <tr className="row">
                  <td className="typeName col-3"><h3 className="secondary-6">Secondary 6</h3></td>
                  <td className="col-1">04</td>
                  <td className="col-1">Uppercase</td>
                  <td className="col-1">400</td>
                  <td className="col-1">20</td>
                ...
                <tr className="row">
                  <td className="typeName col-3"><h1 className="tertiary-1">Tertiary 1</h1></td>
                  <td className="col-1">10</td>
                ...
                <tr className="row">
                  <td className="typeName col-3"><h2 className="tertiary-2">Tertiary 2</h2></td>
                  <td className="col-1">09</td>
                  <td className="col-1">Capitalize</td>
                  <td className="col-1">400</td>
                  <td className="col-1">40</td>
                ...
                <tr className="row">
                  <td className="typeName col-3"><h3 className="tertiary-3">Tertiary 3</h3></td>
                  <td className="col-1">07</td>
                  <td className="col-1">Capitalize</td>
                  <td className="col-1">400</td>
                  <td className="col-1">32</td>
                ...
                <tr className="row">
                  <td className="typeName col-3"><h3 className="tertiary-6">Tertiary 6</h3></td>
                  <td className="col-1">02</td>
                  <td className="col-1">Capitalize</td>
                  <td className="col-1">400</td>
                  <td className="col-1">16</td>
                ...
                <tr className="row">
                  <td className="typeName col-3"><div className="label-lg">Label LG</div></td>
                  <td className="col-1">04</td>
                  <td className="col-1">Uppercase</td>
                ...
                <tr className="row">
                  <td className="typeName col-3"><div className="label-md">Label MD</div></td>
                  <td className="col-1">02</td>
                  <td className="col-1">Uppercase</td>
                  <td className="col-1">Bold</td>
                  <td className="col-1">16</td>
                ...
                <tr className="row">
                  <td className="typeName col-3"><div className="label-sm">Label SM</div></td>
                ...
                <tr className="row">
                  <td className="typeName col-3"><div className="label-xs">Label XS</div></td>
